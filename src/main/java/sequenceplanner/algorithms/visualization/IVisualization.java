 ...
 * Subset: Osubset s.t. Osubset \in Oset, the subset of operations that should be visualized in a SOP.<br/>
 * HasToFinishSet: Ofinish s.t. Ofinish \in Oset, a user can select what operations that has to finish (gives Mk = {Of} instead of Mk = {Oi,Oe,Of}).<br/>
...
public interface IVisualization {
     ...
     * @return true if iIdSet \subseteq Oset else false
     */
     ...
     * -> identify relations for each operation pair in Osubset -> create IRelationsForOperationSet.<br/>
     * @return The relations according to interface IRelationsForOperationSet
     */
