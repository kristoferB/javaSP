...
public class CellFactory {
    ...
    public mxCell getEdge(boolean regular) {
        String style = regular ? "strokeColor=#000000;strokeWidth=2;endArrow=;" +
                "edgeStyle=mxEdgeStyle.ElbowConnector;elbow=vertical;rounded=1" : "strokeColor=#000000;strokeWidth=2;endArrow=";
    ...
    public Cell getOperationCell(Point place) {
        ...
        Cell cell = new Cell(d,
                new mxGeometry(place.getX(), place.getY(), 40, 20),
    ...
    public Cell getParallelCell(Point place) {
        ...
        geo.setAlternateBounds(new mxRectangle(place.getX(), place.getY(), 50, 40));
        ...
        Cell cell = new Cell(d, geo,
                "perimeter=custom.parallelPerimeter;");
    ...
    public Cell getAlternativeCell(Point place) {
        ...
        Cell cell = new Cell(d,
                new mxGeometry(place.getX(), place.getY(), 50, 40),
                "perimeter=custom.alternativePerimeter;");
        cell.setType(Cell.ALTERNATIVE);
        cell.getGeometry().setAlternateBounds(new mxRectangle(place.getX(), place.getY(), 50, 40));
        cell.setId(null);
        cell.setVertex(true);
        cell.setConnectable(false);
    ...
    public Cell getArbitraryCell(Point place) {
        ...
        Cell cell = new Cell(d,
                new mxGeometry(place.getX(), place.getY(), 50, 40),
                "perimeter=custom.operationPerimeter;");
